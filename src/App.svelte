...
<!--    https://github.com/DIvkov575/BSC2.3-->
    ...
    {#if show_d2}
        <div transition:fly={{x: -200, duration: 400}} class="full-width-container"  id="d2">
    ...
    {#if show_d3}
        <div transition:fly={{x:-250, duration: 400}} class="full-width-container" id="d3">
    ...
    {#if show_d4}
        <div transition:fly={{x:-400, duration: 400}} class="full-width-container" id="d4">
            <div class="inner-full-width-container">
    ...
    {#if show_d5}
        <div transition:fly={{x:-400}} id="d5" class="full-width-container">
            <div class="inner-full-width-container">
